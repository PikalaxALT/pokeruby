...
/*static*/ void sub_8044210(u8 a, s16 b, u8 c)
{
    ...
    if ((eBattlerSpritesData[r4].unk0_4) == 0)
        return;
    ptr = str + 6;
    if (c == 0)
    {
...
void sub_804454C(void)
{
    ...
    for (i = 0; i < gBattlersCount; i++)
    {
         ...
         && (IsDoubleBattle() || GetBattlerSide(i) != 0))
        {
            ...
            eBattlerSpritesData[i].unk0_4 ^= 1;
            r6 = eBattlerSpritesData[i].unk0_4;
...
/*static*/ void draw_status_ailment_maybe(u8 a)
{
    ...
    else
    {
        ...
        if (!eBattlerSpritesData[r7].unk0_4)
...
s32 sub_8045C78(u8 a, u8 unused1, u8 c, u8 unused2)
{
    ...
    if (c == 1 || (c == 0 && (!eBattlerSpritesData[a].unk0_4)))
        sub_8045D58(a, c);
    if (r6 == -1)
