...
void sub_80E4300(u8 taskId)
{
    ...
    {
        gTasks[taskId].data[0] = eBattlerSpritesData[gBattleAnimAttacker].invisible;
        eBattlerSpritesData[gBattleAnimAttacker].invisible = TRUE;
...
static void sub_80E4368(u8 taskId)
{
    ...
    {
        eBattlerSpritesData[gBattleAnimAttacker].invisible = gTasks[taskId].data[0] & 1;
        DestroyTask(taskId);
    }
}
