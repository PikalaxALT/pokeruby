...
void sub_81376B8(void)
{
    ...
    if (gSprites[gHealthboxSpriteIds[gActiveBattler]].callback == SpriteCallbackDummy)
        r4 = TRUE;
    if (r4 && eHealthBoxSpritesData[gActiveBattler].unk1_0 && eHealthBoxSpritesData[gActiveBattler ^ 2].unk1_0)
    {
...
void sub_81390D0(void)
{
    ...
    {
    case 0:
        if (eBattlerSpritesData[gActiveBattler].substituteSprite == 1)
...
void sub_81398BC(u8 bank)
{
    ...
    eBattlerSpritesData[bank].transformedSpecies = 0;
